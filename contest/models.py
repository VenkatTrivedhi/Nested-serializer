...
class Colleges(models.Model):
    ...
    contest_id = models.ForeignKey(Contest,on_delete=models.CASCADE,related_name='college')
...
class Challenges(models.Model):
    ...
    college_id = models.ForeignKey(Colleges,on_delete=models.CASCADE,related_name='challenge')
...
class View_Stats(models.Model):
    challenge_id = models.ForeignKey(Challenges,on_delete=models.CASCADE,related_name='view')
...
class Submission_Stats(models.Model):
    challenge_id = models.ForeignKey(Challenges,on_delete=models.CASCADE,related_name='submit')
